...
def interpolate_colors(color_1: Color, color_2: Color, ratio: float, brightness: float = 1) -> Color:
    ...
    """
    color = Color(
        red=round(interpolate_value(color_1.red, color_2.red, ratio, should_round=True) * brightness),
        green=round(interpolate_value(color_1.green, color_2.green, ratio, should_round=True) * brightness),
        blue=round(interpolate_value(color_1.blue, color_2.blue, ratio, should_round=True) * brightness),
    )
